...
public class S_ExpressionViewerApplet extends JApplet implements ActionListener, ChangeListener
{
    ...
    {
        S_ExpressionViewerApplet s_tree = new S_ExpressionViewerApplet();
        if( args.length >= 1 )
        {
    ...
    public S_ExpressionViewerApplet()
    {
        // data
        _S_Expression = "";
        ...
        JSplitPane splitPane = new JSplitPane(JSplitPane.VERTICAL_SPLIT, false, _textField, scrollPane);
