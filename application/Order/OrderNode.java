...
public class OrderNode extends SymbolType
{
  ...
  public OrderNode(String name, int childSize)
  {
  ...
  {
    if (this.getSymbolName().startsWith("J") || target.getSymbolName().startsWith("J"))
    {
  ...
  public static void main(String argv[])
  {
    ...
    symbolSet.addSymbol(new OrderNode("x", 0));
    symbolSet.addSymbol(new OrderNode("y", 0));
    symbolSet.addSymbol(new OrderNode("A", 1));
    symbolSet.addSymbol(new OrderNode("B", 2));
    symbolSet.addSymbol(new OrderNode("C", 3));
