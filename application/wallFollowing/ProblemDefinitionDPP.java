...
public class ProblemDefinitionDPP
{
  ...
  /** Constructor */
  public ProblemDefinitionDPP(String[] args)
  {
    // ***** initialisation step
    ...
    _environment.setPopulationSize(128);
  ...
  {
    ProblemDefinitionDPP problem = new ProblemDefinitionDPP(args);
  }
}
