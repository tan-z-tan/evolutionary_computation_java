...
public class RoyalTreeNode extends SymbolType
{
	...
	public RoyalTreeNode(String name, int childSize)
	{
	...
	public static void main(String argv[])
	{
		...
		symbolSet.addSymbol( new RoyalTreeNode("A", 1) );
		symbolSet.addSymbol( new RoyalTreeNode("B", 2) );
		symbolSet.addSymbol( new RoyalTreeNode("C", 3) );
