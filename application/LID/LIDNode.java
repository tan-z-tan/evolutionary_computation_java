...
public class LIDNode extends SymbolType
{
	...
	public LIDNode(String name, int childSize)
	{
	...
	public static void main(String argv[])
	{
		...
		symbolSet.addSymbol( new LIDNode("x", 0) );
		symbolSet.addSymbol( new LIDNode("y", 0) );
		symbolSet.addSymbol( new LIDNode("A", 1) );
		symbolSet.addSymbol( new LIDNode("B", 2) );
		symbolSet.addSymbol( new LIDNode("C", 3) );
