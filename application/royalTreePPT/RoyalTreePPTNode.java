...
public class RoyalTreePPTNode extends SymbolType
{
	...
	public RoyalTreePPTNode(String name, int childSize)
	{
	...
	public static void main(String argv[])
	{
		...
		symbolSet.addSymbol( new RoyalTreePPTNode("A", 2) );
		symbolSet.addSymbol( new RoyalTreePPTNode("B", 2) );
		symbolSet.addSymbol( new RoyalTreePPTNode("C", 2) );
		symbolSet.addSymbol( new RoyalTreePPTNode("D", 2) );
